...
export function TailwindButton({ children }: Readonly<MagicButtonProps>) {
	return (
		<button className="bg-slate-800 no-underline group cursor-pointer w-fit relative shadow-2xl shadow-zinc-900 rounded-full p-px text-s font-semibold leading-6  text-white inline-block">
